...
const services = [
  ...
  },
  {
    ...
    description: "IT infrastructure, security systems, and integrated technology solutions for airport operations.",
  },
  {
    icon: HardHat,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {services.map((service) => (
              <div
                key={service.title}
                className="bg-card p-8 rounded-xl border border-border hover:border-primary/30 hover:shadow-lg transition-all duration-300"
              >
